const slides = [
  ...
  },
  {
    ...
    title: "結論先講",
    notes:
      "這一頁先給判斷。小型律所通常不是被資安法直接卡住，而是要把個資、委外、保密、留存與權限控管補齊。",
    html: `
      <p class="kicker">Decision</p>
      <div class="quote">一般小型民間律所，多半可以上雲；重點不是能不能用，而是能不能管得住。</div>
      <p class="lead">Google Workspace 可以提供安全與管理底座，但合規責任仍在事務所：資料分類、權限模型、保留政策、外部分享與事件通報，都要被設計出來。</p>`,
  },
  {
    section: "問題定義",
    minutes: "3 分",
  ...
  },
  {
    ...
    notes:
      "資通安全管理法主要看是否為公務機關或特定非公務機關。一般民間小型律所通常不是直接納管對象，但仍受個資、契約、保密與職業倫理約束。",
    html: `
      ...
      <div class="grid-2">
        ...
        <article class="card"><b>多數小型民間律所</b><h3>核心仍是保密與個資治理</h3><p>委任契約、個資保護、職業倫理、客戶保密義務與資料保存責任，仍然需要制度化。</p></article>
      </div>
  ...
  },
  {
    ...
    title: "三份文件就能開始",
    notes:
      "小所不要一開始寫一大本政策。先做可以真的用的三份一頁文件，讓人看得懂，也能持續更新。",
    html: `
      <p class="kicker">Policy pack</p>
      <h1>制度要短，才會被使用。</h1>
      <div class="grid-3">
        <article class="card"><b>01</b><h3>個資與雲端使用政策</h3><p>資料類型、能否上雲、保存多久、何時刪除。</p></article>
        <article class="card"><b>02</b><h3>委外與合約審查表</h3><p>資料處理、保密、事件通報、刪除返還、子處理者。</p></article>
